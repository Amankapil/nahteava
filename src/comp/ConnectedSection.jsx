    ...
    <section className="w-full  mt-0 border-gray-200 bg-[#F5F5F5]">
      ...
      <div className="grid grid-cols-12 border-b border-gray-200">
        ...
        <div className="col-span-9 px-8 py-4">
          ...
          {/* <p className="text-[38px] leading-[48px] w-[80%]">
            Nahteava is an independent consulting firm focused on
            <span className="bg-[#EFE574] px-1 mx-1">IT Asset Management</span>,
            <span className="bg-[#ECA4BD] px-1 mx-1">
              Software Asset Management
            </span>
            , and
            <span className="bg-[#6DA5E1] px-1 mx-1">Strategy</span>.
          </p> */}
          {/* <button >
            ● Learn More
          </button> */}
          ...
          >
            {/* <a href="/your-page-link" class="fancy-btn">
              <span class="bg-box"></span>
              <span class="moree">Learn More</span>
            </a> */}
            <motion.button
        ...
        <div className="col-span-3 flex items-center justify-center border-t border-r border-gray-200 py-6">
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_207_2516)">
                <path
